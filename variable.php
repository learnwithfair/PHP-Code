...
<body>
    <div class="container">
     ...
     <!-- Header start -->
        <div class="header">
            <h1 style="color: white;">Integer and Float variables initialization</h1>
        </div>

        <!-- Body Start -->
        <div class="Body">
            <!--Integer Type variables -->
             <h1>Integer Variables initialization</h1>
           <?php       
                $num1 = 20;
                $num2 = 10;

                $sum = $num1 + $num2;
                echo "The result of these values : " . $sum."</br>";

            ?>
            <h1>String variable initialization</h1>
            <?php
                $str1 = "MD RAHATUL ";
                $str2 = "RABBI";
                $fullName = $str1 . $str2;
