...
<body>
    <div class="container">
        ...
        <!-- Header start -->
        <div class="header">
            <h1 style="color: white;">Data Type Check</h1>
        </div>
        ...
        <div class="Body">
            ...
            //variable initialization
                ...
                $number3 = 10.5432346;
                $str1 = "RAHAT";                    
                $str2 = "MD RAHATUL RABBI";
                $Boolean = true;				
			?>
          
            <h2>
                <ol type = "1">
                    <li><?php echo  var_dump($number1) ?></li>
                    <li><?php echo  var_dump($number2) ?></li>
                    <li><?php echo  var_dump($number3) ?></li>
                    <li><?php echo  var_dump($str1) ?></li>
                    <li><?php echo  var_dump($str2) ?></li>
                    <li><?php echo  var_dump($Boolean) ?></li>
                </ol> 
            </h2>
        </div>
        <!-- Body End -->
