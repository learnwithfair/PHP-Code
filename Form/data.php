    ...
    <div class="containter">
        <table>
            ...
            <tbody>
                ...
                <?php while ( $student_data = mysqli_fetch_assoc( $display_mgs ) ) {?>
                <tr>
                    <td style=""><?php echo $student_data['ID'] ?></td>
                    ...
                    <td method="post" action=""><a class="editbtn"
                        ...
                        <p></p><a name="delete_btn" class="deletebtn"
                            href="data.php?status=delete&&id=<?php echo $student_data['ID'] ?>">Delete</a>
                    </td>
                </tr>
                <?php }?>
            </tbody>
