...
<body>
    <div class="container">
	 ...
	 <!-- Header start -->
        <div class="header">
            <h1 style="color: white;">PHP Arithmatic Operator</h1>
        </div>
        ...
        <h3 class="Body">
            <?php
                ...
                echo "Sumation of ".$number1 ." + ".$number2 ." = ".$sum."</br>";
                echo "Substitution of ".$number1 ." - ".$number2 ." = ".$sub."</br>";
                echo "Multiplication of ".$number1 ." * ".$number2 ." = ".$mul."</br>";
                echo "Division of ".$number1 ." / ".$number2 ." = ".$division."</br>";
                echo "Modulus of ".$number1 ." % ".$number2 ." = ".$modulus."</br>";
			?>
        </h3>
        <!-- Body End -->
